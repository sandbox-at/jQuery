...
<style>
    ...
    @media only screen and (min-width: 420px) {
        ...
        .c-modal-adbe .modal-content .container-adbe,
        .c-modal-adbe .modal-content .modal-adbe {
            min-height: auto;
        }
    }
    ...
    div#sc-lb-module-persistent-bar-adbe a.apply-now-button.rounded-button {
        font-size: 14px;
        font-weight: 400;
        min-width: 150px;
        padding: 10px 24px;
    ...
    /*Adobe customized Persistent Bar Style*/
    .adbe-pop-up-persistent-bar {
        display: flex;
        width: 100%;
    }

    .adbe-pop-up-persistent-bar .adbe-persistent-bar-content {
    ...
    @media only screen and (max-width: 350px) {
        .adbe-pop-up-persistent-bar label span {
            font-size: 11px;
        }
        ...
        .adbe-pop-up-persistent-bar a.apply-now-button span {
            font-size: 11px;
        }
    }
