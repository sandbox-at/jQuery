            ...
            success: function (el) {
                if (!document.querySelector("body").classList.contains("offer-content-adbe")) {
                    try {
                        ...
                        var offerComp_adbe = '<div class="multi-pro" id="multi-pro-adbe" style="opacity:0;visibility: hidden;" data-delay="12"> <a class="close-icon"> <svg viewBox="0 0 50 50" class="opened"> <path d="M3 15 L25 36 L47 15" style="stroke:rgb(255,255,255);stroke-width:5; fill:none" /> </svg> <svg viewBox="0 0 50 50" class="closed"> <path d="M3 36 L25 15 L47 36" style="stroke:rgb(255,255,255);stroke-width:5; fill:none" /> </svg> </a> <div class="flikityParent"> ' + pl_promotion + deposits_promotion + cc_promotion + hl_promotion + loc_promotion+' </div> <div class="progressBarContent"> <a class="prevs"> <i class="iconsMulti"> <svg viewBox="0 0 50 50"> <path d="M35 3 L15 25 L35 47" style="stroke:rgb(255,255,255);stroke-width:7; fill:none" /> </svg> </i> Previous </a> <span class="nextIn">Next promotion in <b class="timeLeft"></b></span> <a class="skips"> <i class="iconsMulti"> <svg viewBox="0 0 50 50"> <path d="M15 3 L35 25 L15 47" style="stroke:rgb(255,255,255);stroke-width:7; fill:none" /> </svg> </i> Next </a> </div> <div class="pBar"> <div class="runningBar"></div> </div> </div>';
